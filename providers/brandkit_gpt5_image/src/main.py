...
from providers.openrouter_gpt5_image import (
    Gpt5ImageRequest,
    OpenRouterGpt5ImageClient,
    mime_to_ext,
    parse_data_url,
)
...
def main() -> int:
    ...
    client = OpenRouterGpt5ImageClient(api_key=api_key)
    ...
    meta_path = os.path.join(brand_folder, "openrouter_gpt5_image_meta.json")
